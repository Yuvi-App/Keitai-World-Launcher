...
Namespace My.Managers
    Public Class CharaDenDownloader
        ...
        Public Async Function DownloadCharaDenAsync(url As String, savePath As String, BatchDownload As Boolean) As Task
            Try
        ...
        Private Sub DownloadFileCompleted(sender As Object, e As System.ComponentModel.AsyncCompletedEventArgs)
            If e.Error IsNot Nothing Then
                MessageBox.Show($"Failed to download the Chara-den: {e.Error.Message}", "Download Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
            Else
