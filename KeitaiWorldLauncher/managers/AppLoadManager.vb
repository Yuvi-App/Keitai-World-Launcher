    ...
    Public Class AppLoadManager
        Public Shared Sub LoadConfigValues(cfg As Dictionary(Of String, String))
            Try
                ...
                MainForm.DefaultSTARSDK = cfg("DefaultSTARSDK")
                MainForm.DefaultJSKYSDK = cfg("DefaultJSKYSDK")
                MainForm.DefaultSOFTBANKSDK = cfg("DefaultSOFTBANKSDK")
                MainForm.DefaultVODAFONESDK = cfg("DefaultVODAFONESDK")
                MainForm.DefaultAIREDGESDK = cfg("DefaultAIREDGESDK")
                MainForm.DefaultEZWEBEZPLUSSDK = cfg("DefaultEZWEBEZPLUSSDK")
                MainForm.DefaultFlashSDK = cfg("DefaultFlashSDK")
                ...
                MainForm.EZWEBEZPLUSpath = cfg("EZWEBEZPLUSpath")
                MainForm.EZWEBEZPLUSEXE = cfg("EZWEBEZPLUSEXEPath")
